...
pane.send_keys("/usr/local/mysql/bin/mysqld --basedir=/usr/local/mysql --datadir=/usr/local/mysql/data --log-error=fuzzerr.err --pid-file=fuzzpid.pid &")
time.sleep(10)
...
pane_client.send_keys("/usr/local/mysql/bin/mysql -u root -e \"create database if not exists test1; create database if not exists fuzz;\"")
time.sleep(5)
...
server_pane.send_keys("/usr/local/mysql/bin/mysqld --basedir=/usr/local/mysql --datadir=/usr/local/mysql/data --log-error=fuzzerr.err --pid-file=fuzzpid.pid --max_execution_time=1000")
